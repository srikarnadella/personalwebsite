    ...
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute left-0 mt-2 w-56 origin-top-left bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none">
          <div className="py-1">
            <a
              href="https://drive.google.com/file/d/1g_E7de5LmT9adWlSACQExIaHzaWICMJC/view?usp=sharing"
              target="_blank"
            ...
            <a
              href="https://drive.google.com/file/d/1AW3BdxNJ7t0aaWvcM6pBGjUYRWyQehIz/view?usp=sharing"
              target="_blank"
              rel="noopener noreferrer"
              className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
            >
              Data Analyics Resume
            </a>
            <a
              href="https://drive.google.com/file/d/1j3hkcznciutSwXYvjvgHyAReg9eZ3968/view?usp=sharing"
              target="_blank"
              rel="noopener noreferrer"
              className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
            >
